...
const payload = {
  ...
  appendedSystemPromptFilePath: instructionsFilePath,
  appendedSystemPromptFileContents: instructionsFilePath ? fs.readFileSync(instructionsFilePath, "utf8") : null,
...
describe("claude execute", () => {
  ...
  it("reuses a stable Paperclip-managed Claude prompt bundle across equivalent runs", async () => {
    ...
    try {
      ...
      expect(capture2.instructionsFilePath).toBeNull();
      ...
      expect(capture2.argv).not.toContain("--append-system-prompt-file");
